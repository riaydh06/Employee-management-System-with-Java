...
public class editEmployee extends javax.swing.JFrame {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(R2))
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(surname, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(Employeeid, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
       ...
       if(x==0){
        try { 
        String  firstname1,surname1,dateofbirth1,email1,mobile1,address11,address21,gender = null,apthouse1,postcode1,department1,designasion1,datehired1,basicsalary1,jobtitle1,status1;
            ...
            department1 = c1.getItemAt(c1.getSelectedIndex());
            // pst.setString(4,c1.getItemAt(c1.getSelectedIndex()));
            designasion1 = designation.getText();
            datehired1 = datehired.getText();
            basicsalary1 = basicsalary.getText();
            jobtitle1= jobtitle.getText();
            status1 = status.getText();
            String sql = "update employee set id ='"+id1+"',firstname='"+firstname1+"',surname='"+surname1+"',dateofbirth='"+dateofbirth1+"',email='"+dateofbirth1+"',mobile='"+mobile1+"',address1='"+address11+"',address2='"+address21+"',gender = '"+gender+"',apthouseno='"+apthouse1+"',postcode='"+postcode1+"',department='"+department1+"',designation='"+designasion1+"',datehired='"+datehired1+"',basicsalary='"+basicsalary1+"',jobtitle='"+jobtitle1+"',status='"+status1+"' where id= '"+id1+"'";
