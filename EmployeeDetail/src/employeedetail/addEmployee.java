...
public class addEmployee extends javax.swing.JFrame {
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
       int x= JOptionPane.showConfirmDialog(null, "Are you sure you want to clear record?","Clear Record",JOptionPane.YES_NO_OPTION);
        ...
        try{
         String sq="select * from employee where (id) not in (select emp_id from users)";
         ...
         while(rs.next()){
            ...
            String add9 = rs.getString("address2");
            String sql = "insert into users (division,username,password,emp_id,email,gender,mobile,country) values ('"+add4+"','"+add2+"','"+add3+"','"+add1+"','"+add5+"','"+add7+"','"+add8+"','"+add9+"')";
            pst = conn.prepareStatement(sql);
            pst.execute();
            JOptionPane.showMessageDialog(null, "User has been created successfully: " +"Username: "+add2+"Password: "+add3);
         }
        }catch(Exception e){
